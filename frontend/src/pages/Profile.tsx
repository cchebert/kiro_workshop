...
const Profile: React.FC = () => {
  ...
  if (!user) {
    return <div className="error-message">{t('profile.userNotFound')}</div>;
  }
        ...
        {isEditing ? (
          ...
          <>
            ...
            <div className="profile-stats">
              <span>{user.followersCount || 0} {t('profile.followers')}</span>
              <span>{user.followingCount || 0} {t('profile.following')}</span>
            </div>
            {isOwnProfile ? (
            ...
            {posts.map(post => (
              <div key={post.id} className="post-card">
                ...
                <div className="post-footer">
                  ...
                  <span>{post.likesCount} {t('profile.likes')}</span>
                  <span>{post.commentsCount} {t('profile.comments')}</span>
                </div>
              </div>
            ))}
          </div>
